...
router.get("/", async (_req, res) => {
  ...
  const games: Record<string, GameMeta> = {
    ...
    roulette: {
      ...
      status: bool("rouletteEnabled", true) ? "live" : "closed",
    ...
    mines: {
      ...
      status: bool("minesEnabled", true) ? "open" : "closed",
    ...
    keno: {
      ...
      status: bool("kenoEnabled", true) ? "live" : "closed",
    ...
    "mob-tower": {
      ...
      status: bool("mobTowerEnabled", true) ? "open" : "closed",
      hasPassword: false,
    },
    fortuna: {
      ...
      status: bool("slotsEnabled", true) ? "open" : "closed",
