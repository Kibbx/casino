...
export const DAILY_POOL: ChallengeDefinition[] = [
  ...
  },
  {
    ...
    total: 3, reward: 2_500, rewardPoints: 15, color: "#eab308",
  },
  {
...
export const SPECIAL_CHALLENGES: ChallengeDefinition[] = [
  {
    ...
    total: 10, reward: 50_000, rewardPoints: 100, color: "#7dd3fc", limited: true,
  },
  {
    id: "s_on_fire", category: "special", icon: "🔥",
    name: "On Fire", desc: "Win $1,000 in a single session",
    total: 1000, reward: 25_000, rewardPoints: 75, color: "#f97316", limited: true,
  },
];
