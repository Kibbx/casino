...
export const tableGamesData: GameDef[] = [
  {
    ...
    players: "8 playing", betRange: "$1 – $1,000",
  ...
  },
  {
    ...
    players: "4 playing", betRange: "$10 – $5,000",
...
export const miniGamesData: GameDef[] = [
  {
    ...
    players: "Solo", betRange: "$0.10 – $500",
