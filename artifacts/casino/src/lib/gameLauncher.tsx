...
export const GAMES: Record<string, GameDef> = {
  ...
  tournaments:{ label: "Tournaments",   cat: "EVENTS",      img: `${IMGS}images/card-tournaments.webp`,      route: "/tournaments-page", key: "tournaments", apiPath: "tournaments", neon: "neon-yellow", direct: true },
