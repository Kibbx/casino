...
export const GAMES: Record<string, GameDef> = {
  ...
  "fortuna":          { label: "Fortuna Slots",   cat: "SLOTS",       img: `${IMGS}images/card-fortuna.png`,          route: "/rome-slots",     key: "slots",       apiPath: "slots",     neon: "neon-purple" },
  "deadwood-dollars": { label: "Deadwood Dollars",cat: "SLOTS",       img: `${IMGS}images/card-deadwood.png`,         route: "/western-slots",  key: "slots",       apiPath: "slots",     neon: "neon-yellow" },
